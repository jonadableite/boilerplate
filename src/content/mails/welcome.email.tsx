...
export const welcomeEmailTemplate = MailProvider.template({
  ...
  schema,
  render: ({ name = 'Brendon Urie', email = 'panic@thedis.co' }) => {
    return (
      <ReactEmail.Html>
        <ReactEmail.Head>
          <style>
        ...
        <ReactEmail.Preview>
          Your account on {AppConfig.name} is ready! Start exploring the
          platform now.
        </ReactEmail.Preview>
        <ReactEmail.Tailwind>
          <ReactEmail.Body className="mx-auto my-auto bg-white font-sans">
            <ReactEmail.Container className="mx-auto my-10 max-w-[500px] rounded-md border border-solid border-gray-200 px-10 py-5">
              ...
              <ReactEmail.Text className="text-sm leading-6 text-black">
                We're excited to have you join {AppConfig.name} — You can see
                that it helps organizations manage users, teams, projects,
                payments, and more. Get ready to streamline your workflows and
              ...
              <div className="space-y-4 my-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-100 rounded-xl px-4">
                    ...
                    <ReactEmail.Text className="text-xs text-gray-600">
                      Select the right plan and securely manage payments for
                      your team
                    </ReactEmail.Text>
                  </div>
                </div>
 ...
 * @returns {JSX.Element} Rendered email template
 */
export default welcomeEmailTemplate.render
