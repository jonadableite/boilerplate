...
export const getAIAgentByIdSchema = z.object({
  id: z.string().uuid("Invalid agent ID"),
});
...
export const uploadKnowledgeBaseDocumentSchema = z.object({
  agentId: z.string().uuid("Invalid agent ID"),
  knowledgeBaseId: z.string().uuid("Invalid knowledge base ID"),
...
export type ConversationHistoryInput = z.infer<
...
export type GetAIAgentByIdInput = z.infer<typeof getAIAgentByIdSchema>;
...
export type UploadKnowledgeBaseDocumentInput = z.infer<typeof uploadKnowledgeBaseDocumentSchema>;
