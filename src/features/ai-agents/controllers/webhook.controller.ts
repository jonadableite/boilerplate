...
export const WebhookController = igniter.controller({
  ...
  actions: {
    ...
    receiveMessage: igniter.mutation({
      ...
      headers: WebhookSignatureSchema,
      handler: async ({ request, response, context }) => {
        try {
          ...
          const result = await context.aiAgent.processEvolutionWebhook({
            payload,
            headers,
            signature: headers['x-evolution-signature'],
          })
    ...
    receiveStatus: igniter.mutation({
      ...
      handler: async ({ request, response, context }) => {
        try {
          ...
          if (!result.success) {
            return response.badRequest({
              message: 'Failed to process status webhook',
              error: result.error,
            })
          }
    ...
    receiveConnection: igniter.mutation({
      ...
      handler: async ({ request, response, context }) => {
        try {
          ...
          if (!result.success) {
            return response.badRequest({
              message: 'Failed to process connection webhook',
              error: result.error,
            })
          }
    ...
    validateWebhook: igniter.query({
      ...
      handler: async ({ request, response }) => {
        try {
          ...
          return response.badRequest({
            message: 'Invalid webhook validation request',
          })
        } catch (error) {
    ...
    testWebhook: igniter.mutation({
      ...
      handler: async ({ request, response, context }) => {
        try {
          ...
          // Testar webhook
          const result = await context.aiAgent.testWebhook({
