...
>(({ className, ...props }, ref) => (
  <CardHeader
    ref={ref}
    className={cn(
      'grid grid-cols-[3fr_1fr] gap-4 items-center p-6 border-b mb-6',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <strong
    ref={ref}
    className={cn('text-sm font-medium text-foreground text-left', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <small
    ref={ref}
    className={cn('text-xs text-muted-foreground mt-1 text-left', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CardFooter
    ref={ref}
    className={cn(
      'flex items-center justify-between bg-secondary/40 border-t px-6 py-1.5',
      className,
    )}
    {...props}
  />
